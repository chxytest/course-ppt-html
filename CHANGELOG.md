...
## 1.3.0 (2026-08-20)
- **新增「风格 C · 头马 Toastmasters 品牌风」**：基于 Swiss 底座 + 头马品牌色令牌；主色 Loyal Blue `#004165` / True Maroon `#772432` / Happy Yellow `#F2DF74` + 渐变端点（Blissful Blue / Deep Maroon / Rich Maroon / Fair Gray）；参数为 `--tier-bg/--tier-fg/--tier-meta` 的分级卡片，换场景可改色不改结构。
